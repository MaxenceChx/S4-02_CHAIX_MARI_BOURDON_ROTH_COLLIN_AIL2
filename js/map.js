    ...
    async function initMap() {
        ...
        try {
            getVeloStations(); // Stations de vélo
        } catch (error) {
            console.error("Erreur lors de l'obtention des stations de vélo:", error);
        }

        try {
            getBusStops(); // Arrêts de bus
        } catch (error) {
            console.error("Erreur lors de l'obtention des arrêts de bus:", error);
        }
